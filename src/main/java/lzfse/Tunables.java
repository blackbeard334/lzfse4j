...
public final class Tunables {
    ...
    static final int LZFSE_ENCODE_HASH_BITS = 14;
    ...
    static final int LZFSE_ENCODE_HASH_WIDTH = 4;
    ...
    //  compression ratios.
    static final int LZFSE_ENCODE_GOOD_MATCH = 40;
    ...
    static final int LZFSE_ENCODE_LZVN_THRESHOLD = 4096;
